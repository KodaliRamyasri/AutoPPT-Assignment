"""
MCP Server — full AutoPPT AI-quality PPT tools over stdio
...
# ── MCP Server ────────────────────────────────────────────────────────────────
server = Server("autoppt-ppt-mcp-server")
...
async def call_tool(name: str, arguments: dict) -> list[types.TextContent]:
    ...
    if name == "add_title_slide":
        ...
        _textbox(ts, "Generated by AutoPPT AI", Inches(0.7), Inches(5.2), Inches(5.5), Inches(0.4), 12, THEME["accent"])
