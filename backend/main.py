...
Exposes the same /generate, /export, /image-proxy endpoints as AutoPPT AI backend main.py
...
# Reuse AutoPPT AI's generator directly (same LLM logic, no duplication)
...
# ── /generate — identical to AutoPPT AI backend ────────────────────────────────
...
# ── /image-proxy — identical to AutoPPT AI backend ────────────────────────────
